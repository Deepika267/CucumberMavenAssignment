...
In the first scenario, the user will order a Tshirt
and validate if order is reflecting in order history

In the second scenario,the user updates first name information
